...
I have about six years of Python and SQL experience, mostly in healthcare analytics at UCLA Health (PostgreSQL, pandas, Tableau dashboards, statistical pilot programs), and I'm finishing an MS in Data Science at Boston University in December 2026. I've built small FastAPI and Streamlit apps with scikit-learn and gradient-boosting models, and I use Git and Docker day to day. I'm beginner-to-intermediate at ML engineering and want to get better at reading and contributing to real Python codebases I didn't write, especially RAG pipelines, API code, and their tests. For a first issue I'd rather stay in Python and avoid front-end or JavaScript-heavy work.
